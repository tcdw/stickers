...
export const stickersByMood: Record<string, Sticker[]> = {
  ...
  loving: stickers.filter(s => ['sticker-2', 'sticker-6', 'sticker-8', 'sticker-20', 'sticker-25', 'sticker-26', 'sticker-27', 'sticker-28', 'sticker-29', 'sticker-32', 'sticker-33'].includes(s.id)),
  ...
  sad: stickers.filter(s => ['sticker-13', 'sticker-16', 'sticker-17', 'sticker-31'].includes(s.id)),
